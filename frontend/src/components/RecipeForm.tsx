import { Carrot, ListPlus, Trash2 } from 'lucide-react'
...
export const RecipeForm = ({
  ...
  const handleIngredientCreated = (ingredient: Ingredient) => {
    prepend(
      { ingredient_id: ingredient.id, quantity: '' },
      { focusName: 'ingredients.0.quantity' },
    )
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex flex-wrap gap-2">
              <Button
                ...
                type="button"
                onClick={() =>
                  prepend(emptyIngredientRow, {
                    focusName: 'ingredients.0.ingredient_id',
                  })
                }
              >
                Add ingredient
